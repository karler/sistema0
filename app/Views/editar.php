<html>
	...
	<body>
        ...
        <form method="POST" action="<?= base_url() ?>/public/contactos/actualizar">
            <div class="form-group row">
                <label for="idcontacto" class="col-4 col-form-label">Id Contacto</label> 
                <div class="col-8">
                <input id="nombre" name="idcontacto" type="text" class="form-control" value ="<?=$datos['idcontacto']?>">
                </div>
            </div>
			<div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                <input id="email" name="email" type="text" class="form-control" value ="<?=$datos['email']?>">
                </div>
            </div>
            <div class="form-group row">
